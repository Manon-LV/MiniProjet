...
np.save('results/03/qiteration_avg_rewards.npy', avg_rewards)
np.save('results/03/qiteration_success_rates.npy', success_rates)
np.save('results/03/qiteration_episode_rewards.npy', episode_rewards)
np.save('results/03/qiteration_losses.npy', losses)
np.save('results/03/qiteration_training_times.npy', training_times)